      ...
      <div class="inbox_msg">
        ...
        <div class="mesgs">
          <div class="msg_history">
            <div v-for="(value, index) in messages" :key="index" class="incoming_msg">
              <div :class="[value.author === authUser.email ? 'sent_msg' : 'received_msg']">
                <div class="received_withd_msg">
                  <p>{{value.message}}</p>
                  <span class="time_date">{{value.author}}</span>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    saveMessage() {
      // save to firestore 数据库中创建 chat 集合
      db.collection('chat')
        .add({
